object Dependencies {
    ...
    // kotest
    const val KOTEST_RUNNER_JUNIT5 = "io.kotest:kotest-runner-junit5:${DependencyVersions.KOTEST_VERSION}"
    const val KOTEST_ASSERTIONS_CORE = "io.kotest:kotest-assertions-core:${DependencyVersions.KOTEST_VERSION}"
    const val KOTEST_FRAMEWORK_DATATEST = "io.kotest:kotest-framework-datatest:${DependencyVersions.KOTEST_VERSION}"
